...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        hamburger.addHamburgerAddition("Addition1",1);
        hamburger.addHamburgerAddition("Addition2",2);
        hamburger.addHamburgerAddition("Addition3",3);
        hamburger.addHamburgerAddition("Addition4",4);
